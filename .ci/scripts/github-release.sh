...
export PROJECT_NAME="Flaky Test Extractor Maven Plugin"
export GITHUB_TOKEN=${GITHUB_TOKEN_PSW}
export GITHUB_ORG=zeebe-io
export GITHUB_REPO=flaky-test-extractor-maven-plugin
export ARTIFACT=flaky-test-extractor-maven-plugin-${RELEASE_VERSION}.jar
