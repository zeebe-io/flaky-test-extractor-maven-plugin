...
/**
 * Based on {@code org.apache.maven.plugins.surefire.report.SurefireReportParser} (licensed under
 * http://www.apache.org/licenses/LICENSE-2.0).
 *
 * <p>This implementation uses the extended data objects to capture more information on flaky tests
 */
  ...
  public Map<File, List<ExtendedReportTestSuite>> parseXMLReportFiles() throws ParsingException {
    ...
    for (File xmlReportFile : xmlReportFiles) {
      try {
        ...
        logger.info(
            "Skipping "
                + xmlReportFile.getName()
                + " because of parsing exception:"
