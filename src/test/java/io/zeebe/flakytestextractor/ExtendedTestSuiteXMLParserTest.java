...
public class ExtendedTestSuiteXMLParserTest {
  ...
  @Test
  public void testParseOutputOfPassingTest()
      throws ParserConfigurationException, SAXException, IOException {
    try (InputStreamReader reader =
        getReaderForClassPathResource(
  ...
  @Test
  public void testParseOutputOfFailingTest()
      throws ParserConfigurationException, SAXException, IOException {
    try (InputStreamReader reader =
        getReaderForClassPathResource(
  ...
  @Test
  public void testParseOutputOfErrorTest()
      throws ParserConfigurationException, SAXException, IOException {
    try (InputStreamReader reader =
        getReaderForClassPathResource(
  ...
  @Test
  public void testParseOutputOfFlakyTest()
      throws ParserConfigurationException, SAXException, IOException {
    try (InputStreamReader reader =
        getReaderForClassPathResource(
      ...
      assertThat(testCase.getFailureDetail())
          .isEqualTo(
  ...
  @Test
  public void testParseOutputOfFlakyError()
      throws ParserConfigurationException, SAXException, IOException {
    try (InputStreamReader reader =
        getReaderForClassPathResource(
      ...
      assertThat(testCase.getFailureDetail())
          .isEqualTo(
              "java.lang.RuntimeException: Oops, something happeeed\n"
